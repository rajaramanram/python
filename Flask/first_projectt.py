...
'''{
  ...
  "COUNT": 3,
  "CINAME": "devserver",
  "CREATED_TIME": "2020-11-26T06:19:04.212298Z",
  "ENVIRONMENT":"DOCKER",
  "IP": "172.16.1.105",
  "SEVERITY": "WARNING",
  ...
  "LAST_MODIFIED_TIME": "2020-11-26",
  "STATUS": "acknowledged",
  "MODIFIED_BY": "sam",
  "TAGS":"MEMORY,LINUX"
}

res=es.index(index='first_project', doc_type='_doc', body=output)
print(res)'''
...
def receive_data():
    ...
    for i in mandatory_field_list:
        if i not in data:
          return jsonify({'status': False, 'data': 'No Data Found'})
    #return jsonify({'status': True, 'data': 'Data Found'})
