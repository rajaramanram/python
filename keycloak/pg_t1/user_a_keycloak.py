...
app.config.update({
    ...
    'DEBUG': True,
    'OIDC_CLIENT_SECRETS': 'c:/Python/codes/Autointelli/Flask/four_api/keycloak/pg_t1/client_secrets.json',
...
def receive_data():
    if request.method == 'GET':
        ...
        app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://postgres:rajaraman@localhost:5432/customer_a"
...
#"client_secret": "245f4934-ddbc-45ec-9aea-c188591f37c0",
