...
message["Subject"] = "sir,one doubt sir,here separate rows for multiple service,or i do separate mail for multiple service sir,please tell"
...
template=env.get_template('status_email.html')
output=template.render(hostname=hostname,servicename=service_name,html_service= html_service,data_time=total_date_time)
print(output)
