...
if(ps_connection):
    ...
    #print(alert_records)
    web_urls = {
            "issuer": alert_records[0][2].format("http","localhost","8080","customer_c"),
            "auth_uri": alert_records[0][3].format("http", "localhost", "8080", "customer_c"),
            "client_id": alert_records[0][4].format("http", "localhost", "8080", "customer_c"),
            "client_secret": alert_records[0][5].format("http", "localhost", "8080", "customer_c"),
            "redirect_uris": alert_records[0][6].format("http", "localhost", "8080", "customer_c"),
            "userinfo_uri": alert_records[0][7].format("http", "localhost", "8080", "customer_c"),
            "token_uri": alert_records[0][8].format("http", "localhost", "8080", "customer_c"),
